...
st.markdown("This application is to analysis the sentiment of tweets 🐦")
st.sidebar.markdown("This application is to analysis the sentiment of tweets 🐦")
URL="Tweets.csv"
...
choice= st.sidebar.multiselect('pick airline',('US Airways', 'United','American','Southwest'),key='0')
if len(choice)>0:
# choice_data=data[data['airline'] == choice]
    choice_data=data[data.airline.isin(choice)]
    fig_chice=px.histogram(choice_data, x='airline',y='airline_sentiment'
    , histfunc='count', color='airline_sentiment', facet_col='airline_sentiment'
    , labels={'airline_sentiment':'tweets'},height=600, width=800)
    st.plotly_chart(fig_chice)
